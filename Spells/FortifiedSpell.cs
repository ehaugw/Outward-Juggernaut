...
namespace Juggernaut
{
    ...
    public class CharacterEquipment_GetEquipmentDamageResistance
    {
        ...
        public static void Postfix(CharacterEquipment __instance, ref float __result, ref DamageType.Types _type)
        {
            ...
            {
                if ((SkillRequirements.CanAddProtectionToPhysicalResistance(character) && _type == DamageType.Types.Physical) || SkillRequirements.CanAddProtectionToAnyDamageResistance(character))
                {
